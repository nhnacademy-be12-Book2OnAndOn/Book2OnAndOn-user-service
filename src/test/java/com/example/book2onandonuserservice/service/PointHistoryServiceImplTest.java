...
class PointHistoryServiceImplTest {
    ...
    void usePoint_success_fifo() {
        ...
        when(pointHistoryRepository
                .findByUserUserIdAndPointHistoryChangeGreaterThanAndRemainingPointGreaterThanOrderByPointCreatedDateAsc(
                        1L, 0, 0
    ...
    void refundPoint_success() {
        ...
        when(pointHistoryRepository.findByOrderItemId(201L))
                .thenReturn(List.of());
